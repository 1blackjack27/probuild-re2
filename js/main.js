...
const translations = {
  es: {
    ...
    hero_h1: '<em>Trabajo Ético.</em><span class="h1-line">Alta Tecnología.</span><span class="h1-line">Confianza Total.</span>',
    hero_sub: '<strong class="hero-tags"><span>Electricidad</span><span>Plomería</span><span>Techos</span><span>Construcción</span></strong><br/>Soluciones integrales para tu propiedad en Miami, cuidando tu inversión como si fuera la nuestra.',
  ...
  en: {
    ...
    nav_cta: 'Free Quote',
    hero_eyebrow: 'Miami, Florida — Est. 2024',
    hero_h1: '<em>Ethical Work.</em><span class="h1-line">High Technology.</span><span class="h1-line">Total Trust.</span>',
    hero_sub: '<strong class="hero-tags"><span>Electrical</span><span>Plumbing</span><span>Roofing</span><span>Construction</span></strong><br/>Comprehensive solutions for your property in Miami, protecting your investment as if it were our own.',
